...
class PDF
{
    ...
    public function renderHeaderHTML(): ?string
    {
        ...
        if (isset($this->options->headerTemplate) && file_exists($this->getViewTemplateByName("headers/{$this->options->headerTemplate}"))) {
    ...
    public function renderFooter($mpdf): void
    {
        ...
        if (isset($this->options->footerTemplate) && file_exists($this->getViewTemplateByName("footers/{$this->options->footerTemplate}"))) {
